...
SQL is the language many relational databases are written in but relational databases are databases that consist of two or more tables with columns and rows.

- [ ] Why do tables need a `primary key`?
Each entry needs a unique identifier for data integrity

- [ ] What is the name given to a table column that references the primary key on another table.
Foreign Key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
A join or manager table.
